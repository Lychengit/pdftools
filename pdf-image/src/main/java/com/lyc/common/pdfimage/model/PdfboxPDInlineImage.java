 ...
 * @author John Hewson
 */
public final class PdfboxPDInlineImage implements PDImage
{
    // image parameters
     ...
     */
    public PdfboxPDInlineImage(COSDictionary parameters, byte[] data, PDResources resources,
                               File fileSource, File fileDest, List<String> filters)
            throws IOException
    {
        ...
        {
			this.decodedDatafile = fileSource;
        }
        else
        {
     ...
     * @return A (possibly empty) list of filters applied to this stream, never null.
     */
    public static List<String> getFilters(COSDictionary parameters)
    {
        COSBase filters = parameters.getDictionaryObject(COSName.F, COSName.FILTER);
        if (filters instanceof COSName)
        {
    ...
    {
        return new FileInputStream(decodedDatafile);
    }
    ...
    {
        return decodedDatafile.length() == 0;
    }

    @Override
    public BufferedImage getImage() throws IOException
    {
        return PdfboxSampledImageReader.getRGBImage(this, null);
    }

    @Override
    public BufferedImage getImage(Rectangle region, int subsampling) throws IOException
    {
        return PdfboxSampledImageReader.getRGBImage(this, region, subsampling, null);
    }

    @Override
    public WritableRaster getRawRaster() throws IOException
    {
        return PdfboxSampledImageReader.getRawRaster(this);
    }
    ...
    public BufferedImage getStencilImage(Paint paint) throws IOException
    {
        ...
        return PdfboxSampledImageReader.getStencilImage(this, paint);
    }
