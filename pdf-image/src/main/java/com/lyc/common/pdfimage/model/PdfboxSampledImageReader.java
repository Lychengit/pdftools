 ...
 *
 * 注意：MemoryCacheImageInputStream这里改动关闭PdfboxPDInlineImage#createInputStream()打开的流句柄
 */
final class PdfboxSampledImageReader
{
    private static final Log LOG = LogFactory.getLog(PdfboxSampledImageReader.class);
    
    private PdfboxSampledImageReader()
    {
    }
            ...
            throws IOException
    {
        ...
        // read bit stream
        try (InputStream inputStream = pdImage.createInputStream(options);
